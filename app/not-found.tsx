  ...
  return (
    <div className="container mx-auto px-6 py-32 text-center lg:px-8">
      <Reveal className="mx-auto max-w-xl space-y-6">
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-slate-500 dark:text-slate-400">404</p>
        <h1 className="text-4xl font-semibold text-primary dark:text-white">We lost that constellation</h1>
